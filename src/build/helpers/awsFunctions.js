...
var dynamo = __importStar(require("./dynamodb"));
var s3Functions_1 = require("./s3Functions");
/**
 * Uploads the file to Amazon S3 and saves the detected text to DynamoDB.
 * @param {DetectedText} details - The detected text details to save.
 ...
 */
function awsUpload(details, s3Key) {
    return __awaiter(this, void 0, void 0, function () {
        var s3Upload, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, s3Functions_1.saveToS3)(s3Key, details.serialNumber)];
                case 1:
                    s3Upload = _a.sent();
                    details.s3Url = s3Upload;
                    // Save detected text to DynamoDB
                    return [4 /*yield*/, dynamo.insertIntoDynamo(details)];
                case 2:
                    // Save detected text to DynamoDB
                    _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error in awsUpload:', error_1);
                    return [3 /*break*/, 4];
