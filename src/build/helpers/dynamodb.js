...
exports.insertIntoDynamo = void 0;
 ...
 */
function insertIntoDynamo(item) {
    return __awaiter(this, void 0, void 0, function () {
        var dynamodb, params, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dynamodb = new aws_sdk_1.default.DynamoDB.DocumentClient({ region: 'us-east-1' });
                    params = {
                ...
                case 3:
                    ...
                    console.error('Error putting item to DynamoDB:', error_1);
                    throw error_1;
...
exports.insertIntoDynamo = insertIntoDynamo;
