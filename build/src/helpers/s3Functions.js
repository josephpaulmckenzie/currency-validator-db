 ...
 */
function saveToS3(filePath, Key) {
    return __awaiter(this, void 0, void 0, function () {
        var s3, params, response, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    params = {
                        Bucket: 'currencydb',
                        Key: Key,
                        Body: fs.readFileSync("uploads/".concat(filePath)),
                    };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    return [2 /*return*/, response.Location]; // Return the S3 object URL
                case 3:
                    error_1 = _a.sent();
